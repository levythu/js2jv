...
public class Javascript extends JsFunction
{
	...
	public JsVar ExecuteDetail(JsClosure closureInfo) throws Exception
	{
		...
		closureInfo.Declare("v403", new JsString("1 + 2"));
		...
		closureInfo.Declare("v412", new JsString("6 / 3"));
		...
		closureInfo.Set("v418",closureInfo.Get("console"));
		closureInfo.Declare("v419", new JsList());
		closureInfo.Declare("v420", new JsList());
		closureInfo.Declare("v421", new JsString("5 / 3"));
		((JsList)(closureInfo.Get("v420")))._push(closureInfo.Get("v421"));
		closureInfo.Set("v422",closureInfo.Get("calculate").Execute((JsList)closureInfo.Get("v420")));
		((JsList)(closureInfo.Get("v419")))._push(closureInfo.Get("v422"));
		closureInfo.Set("v423",closureInfo.Get("v418").GetProperty(new JsString("log")).Execute((JsList)closureInfo.Get("v419")));
		closureInfo.Set("v427",closureInfo.Get("console"));
		closureInfo.Declare("v428", new JsList());
		closureInfo.Declare("v429", new JsList());
		closureInfo.Declare("v430", new JsString("5 * 3"));
		((JsList)(closureInfo.Get("v429")))._push(closureInfo.Get("v430"));
		closureInfo.Set("v431",closureInfo.Get("calculate").Execute((JsList)closureInfo.Get("v429")));
		((JsList)(closureInfo.Get("v428")))._push(closureInfo.Get("v431"));
		closureInfo.Set("v432",closureInfo.Get("v427").GetProperty(new JsString("log")).Execute((JsList)closureInfo.Get("v428")));
		closureInfo.Set("v436",closureInfo.Get("console"));
		closureInfo.Declare("v437", new JsList());
		closureInfo.Declare("v438", new JsList());
		closureInfo.Declare("v439", new JsString("5 - 3"));
		((JsList)(closureInfo.Get("v438")))._push(closureInfo.Get("v439"));
		closureInfo.Set("v440",closureInfo.Get("calculate").Execute((JsList)closureInfo.Get("v438")));
		((JsList)(closureInfo.Get("v437")))._push(closureInfo.Get("v440"));
		closureInfo.Set("v441",closureInfo.Get("v436").GetProperty(new JsString("log")).Execute((JsList)closureInfo.Get("v437")));
		closureInfo.Set("v445",closureInfo.Get("console"));
		closureInfo.Declare("v446", new JsList());
		closureInfo.Declare("v447", new JsList());
		closureInfo.Declare("v448", new JsString("1 + 2 * (3 - 4) / 5+6/5"));
		((JsList)(closureInfo.Get("v447")))._push(closureInfo.Get("v448"));
		closureInfo.Set("v449",closureInfo.Get("calculate").Execute((JsList)closureInfo.Get("v447")));
		((JsList)(closureInfo.Get("v446")))._push(closureInfo.Get("v449"));
		closureInfo.Set("v450",closureInfo.Get("v445").GetProperty(new JsString("log")).Execute((JsList)closureInfo.Get("v446")));
		closureInfo.Set("v454",closureInfo.Get("console"));
		closureInfo.Declare("v455", new JsList());
		closureInfo.Declare("v456", new JsList());
		closureInfo.Declare("v457", new JsString("( 1 + 2 ) * (( 3 - 4 ) / 5)"));
		((JsList)(closureInfo.Get("v456")))._push(closureInfo.Get("v457"));
		closureInfo.Set("v458",closureInfo.Get("calculate").Execute((JsList)closureInfo.Get("v456")));
		((JsList)(closureInfo.Get("v455")))._push(closureInfo.Get("v458"));
		closureInfo.Set("v459",closureInfo.Get("v454").GetProperty(new JsString("log")).Execute((JsList)closureInfo.Get("v455")));
		closureInfo.Set("v462",closureInfo.Get("process"));
		closureInfo.Declare("v463", new JsList());
		closureInfo.Declare("v464", JsNumber.initLiteral(0));
		((JsList)(closureInfo.Get("v463")))._push(closureInfo.Get("v464"));
		closureInfo.Set("v465",closureInfo.Get("v462").GetProperty(new JsString("exit")).Execute((JsList)closureInfo.Get("v463")));
